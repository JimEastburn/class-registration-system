...
echo "🧪 Test: View enrollments list"
echo "==============================="
...
agent-browser screenshot "$SCREENSHOTS_DIR/view-enrollments.png"

CURRENT_URL=$(agent-browser get url)
if [[ "$CURRENT_URL" == *"/enrollments"* ]]; then
  echo "✅ SUCCESS: Enrollments page loaded"
else
  echo "⚠️ INFO: Redirected from enrollments page"
fi
