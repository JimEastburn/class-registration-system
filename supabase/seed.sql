...
BEGIN
    ...
    INSERT INTO public.family_members (id, parent_id, first_name, last_name, grade_level, relationship)
    VALUES 
        (child_jane_id, parent_john_id, 'Jane', 'Doe', '8', 'child'),
        (child_jack_id, parent_john_id, 'Jack', 'Doe', '10', 'child')
