    ...
    try {
      ...
      `)
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `${process.env.NEXT_PUBLIC_APP_URL}/parent/enrollments?success=true&enrollment=${enrollmentId}`,
            cancel_url: `${process.env.NEXT_PUBLIC_APP_URL}/parent/enrollments?canceled=true`,
            metadata: {
