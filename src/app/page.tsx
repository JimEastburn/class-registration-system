    ...
    <div className="min-h-screen relative text-white">
      ...
      <div className="relative z-20 min-h-screen flex flex-col">
        ...
        <nav className="container mx-auto px-4 py-6 flex items-center justify-between">
          <span className="text-2xl font-bold bg-gradient-to-r from-teal-400 to-yellow-400 bg-clip-text text-transparent">
            ClassReg
          </span>
        ...
        <main className="container mx-auto px-4 py-20 flex-grow flex flex-col justify-center">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/register">
                <Button size="lg" className="bg-purple-800 hover:bg-purple-900 text-white text-lg px-8 py-6 h-auto w-full sm:w-auto">
                  Start Free →
                </Button>
              </Link>
              <Link href="/login">
