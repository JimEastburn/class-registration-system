        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700 dark:text-blue-400">
                  You have secured a spot but need to pay before September 2nd in order to attend the class.
                </p>
                <p className="text-xs text-blue-700 dark:text-blue-400">
                  Payment options are coming soon! We&apos;ll let you know when you can pay.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="font-medium">Confirmed and paid</p>
                <p className="text-xs text-blue-700 dark:text-blue-400">
