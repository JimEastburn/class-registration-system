  ...
  return (
    <div className="space-y-6">
      ...
      <Suspense fallback={<ClassGridSkeleton />}>
        <ClassListWrapper search={params.search} day={params.day} />
      </Suspense>
    </div>
  );
}
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Failed to load classes: {error}</CardDescription>
        </CardHeader>
      </Card>
    );
  }
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            There are no published classes at this time. Please check back
            later.
          </CardDescription>
        </CardHeader>
      </Card>
