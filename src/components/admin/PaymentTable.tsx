        ...
        <TableBody>
          {data.map((payment) => (
            ...
            >
              ...
              <TableCell>
                {payment.enrollment?.student?.parent?.first_name}{' '}
                {payment.enrollment?.student?.parent?.last_name}
                <br />
                <span className="text-muted-foreground text-xs">
                  {payment.enrollment?.student?.parent?.email}
                </span>
              </TableCell>
              <TableCell>
              ...
              <TableCell>{fmtCurrency(payment.amount)}</TableCell>
              <TableCell>
                <Badge
                  variant={
