    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to cancel {studentName}&apos;s enrollment in{' '}
            {className}?
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          ...
          <p className="text-muted-foreground text-sm">
            Note: Refund processing depends on payment status. A full refund
            will be attempted if selected.
          </p>
