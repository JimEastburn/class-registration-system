      ...
      <section className="space-y-3">
        ...
        <div className="bg-background overflow-x-auto rounded-lg border">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr>
                <th className="bg-muted sticky left-0 z-20 min-w-64 border-b px-4 py-3 text-left font-semibold">
                  Role
                </th>
                {board.blocks.map((block) => (
                  <th
                    key={block.id}
                    className="bg-muted min-w-36 border-b border-l px-3 py-3 text-center font-semibold"
                  >
                    {block.name}
                  </th>
                ))}
