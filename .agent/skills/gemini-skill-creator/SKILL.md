...
description: GUIDELINES for creating new skills. Use this skill when the user asks you to create a new skill, generate a skill structure, or defines a new capability they want you to remember.
---
