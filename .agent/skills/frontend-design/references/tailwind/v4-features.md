...
<div
  popover
  class="transition-all starting:open:scale-95 starting:open:opacity-0"
></div>
```
...
<p class="text-shadow-blue-500/50 text-shadow-lg">Colored</p>
```
...
<div class="pointer-coarse:p-4 pointer-fine:p-2">
  ...
  <details class="details-content:mt-3">
    ...
    <div class="inverted-colors:shadow-none">
      <!-- Noscript -->
      <div class="hidden noscript:block">Enable JS</div>
    </div>
  </details>
</div>
```
